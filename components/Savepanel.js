...
export const Savepanel = () => {
  ...
  <div>
    <div className="relative">
        <div className='hidden md:block md:relative md:mt-[-46px] lg:mt-[-55px] thirteen:mt-[-70px] xl:mt-[-75px] sixteen:mt-[-87px]'>
          <img src={savePanel} width={1920} height={957} alt="" />
        </div> 
