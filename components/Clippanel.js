    ...
    return (
      <>
        ...
        <div className="relative">
          ...
          <div className="content-clip absolute top-2 md:top-[36%] md:left-[11%] md:w-[34%] lg:top-[25%] lg:left-[62%]">
            <h2 className='pb-12 md:pb-4'>Clip</h2>
            <p className='subhead md:text-2xl md:pb-2'>We Know Greatness When We See It, Too. 
            </p>
          ...
          <div className="hidden right-col md:block absolute md:top-[31%] md:w-[39%] md:left-[52%]">
