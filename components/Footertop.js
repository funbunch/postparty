    ...
    <>
      <div className='grid md:hidden'>
        <div className="self-start grid row-start-1 col-start-1 -mt-8">
          <Image src={footerTopMob} width={414} height={308} alt="" />
        </div>
        <div className="content flex flex-col row-start-1 col-start-1 items-center justify-evenly">
            <div className="logo">
              <Image src={footerLogo} width={93} height={73}  alt="Postparty Logo" />
            </div>
            ...
            <div className="apple lg:hidden pr-5 inline-block">
              <Image src={appleBadgeMob} width={92} height={30} alt="Get Apple" />
            </div>
            <div className="google inline-block">
              <Image src={googleBadgeMob} width={103} height={30} alt="Get Google" />
            </div>
          </div>
        </div>
      </div>
      <div className="hidden md:grid">
        <div className="hidden md:self-start md:grid md:row-start-1 md:col-start-1 mt-[-6px]">
          <Image src={footerTop} width={1920} height={733} alt="" />
        </div>
        <div className="content flex flex-col row-start-1 col-start-1 items-center justify-evenly">
          <div className="logo md:w-[150px] lg:w-[186px]">
            <Image src={footerLogo} width={186} height={146} alt="Postparty logo" />
          </div>
          ...
          <div className="badge hidden md:block">
            <div className="apple pr-7 inline-block">
              <Image src={appleBadge} width={161} height={53} alt="Get Apple" />
            </div>
            <div className="google inline-block">
              <Image src={googleBadge} width={182} height={54} alt="Get Google" />
            </div>
          </div>
      </div>
    </div>
