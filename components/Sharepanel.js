  ...
  return (
    <div>
      <div className="relative">
        ...
        <div className="content-clip absolute top-2 md:top-[29%] md:left-[11%] md:w-[40%] lg:top-[35%] lg:left-[10%] lg:w-[32%]">
          ...
          <div className="hidden left-col md:block absolute md:top-48 md:w-[39%] md:left-0 lg:top-[25%]">
          <Image src={social} width={183} height={39} layout='intrinsic'/>
        </div>  
        </div>
        <div className="hidden left-col md:block absolute md:top-[25%] md:w-[44%] md:right-0 lg:top-[25%]">
