  ...
  return (
    <div>
        ...
        If you have an issue that our player support can’t resolve, prior to starting arbitration you and Epic agree to attempt to resolve the dispute informally to help get us to a resolution and reduce costs for both parties. You and Epic agree to make a good-faith effort to negotiate any dispute between us for at least 30 days (“<span className="font-bold">Informal Resolution</span>”). This 30 day period starts on the day you or Epic receive a written notice of a dispute from the other party (a “<span className="font-bold">Notice of Dispute</span>”) in accordance with this Agreement.</p>
          <p className="faqs">You will send your Notice of Dispute to Epic Games, Inc., Legal Department, ATTN: NOTICE OF DISPUTE, Box 254, 2474 Walnut Street, Cary, North Carolina, 27518, U.S.A. Include your name, any relevant account name you use, address, how to contact you, what the problem is, and what you want Epic to do. If Epic has a dispute with you that is subject to Informal Resolution, Epic will send our Notice of Dispute to your registered email address and any billing address you have provided us</p>
          <p className="faqs">If you reside in the European Union (“EU”), you may also be entitled to submit your complaint to the European Commission’s Online Dispute Resolution (ODR) Platform. ODR allows EU consumers to resolve disputes related to the online purchases of goods and services without going to court</p>
          <p className="faqs">If the dispute isn’t resolved within 30 days by Informal Resolution or small-claims court (below), you or Epic may start an arbitration in accordance with this Agreement.</p>
          <p className="faqs">
        ...
        <p className="faqs"> This means that you and Epic agree to a dispute-resolution process where we submit any Dispute to a neutral arbitrator (not a judge or jury) that makes the final decision to resolve the Dispute. The arbitrator may award the same remedies to you individually as a court could, but only to the extent required to satisfy your individual claim.</p>
        <p className="faqs ul">The arbitrator’s decision is final, except for a limited review by courts under the U.S. Federal Arbitration Act and can be enforced like any other court order or judgment.</p>
        ...
        <p className="faqs ul"><span className="font-bold">d. Class Action Waiver</span><br/>
        ...
        <p className="faqs"><span className="font-bold">e.	Severability</span><br/>
        ...
        <p className="faqs"><span className="font-bold">f.	Your 30-Day Right to Opt Out</span><br />
