    ...
    <div>
        ...
        row-start-1 col-start-1 items-center pt-7 md:px-5 md:pt-24 z-30">
          ...
          <div className="inside md:col-span-9">
            <h2 className="text-[#141414] md:text-[55px] md:pb-12"><a href="#general">How to contact us?</a></h2>
            ...
            <p className="space"><span className="font-bold md:text-base">Q: How to download Postparty app?</span><br />
              ...
              A: Glad you're finally joining us! You have 3 options: you can create a new account in a web browser, create an account in-game, or through the Postparty app by clicking sign-in and scrolling down to click "sign up."<br/> 
              <Link href="#"><a>Sign in</a></Link> </p>
              ...
              A: 	By default, we capture the last 30 seconds of game play. To trim a clip, open the clip review and tap "edit," change the start and endpoint, and hit save. Magic.</p>
              ...
              <h2 id="#fortnite" className="text-[#141414] md:text-[55px] md:pb-12 pt-10"> Fortnite Specific Questions</h2>
            ...
            <p className="space"><span className="font-bold md:text-base">Q: Issues with clipping in Fortnite and how to solve them</span><br />
              ...
              <h2 className="text-[#141414] md:text-[55px] md:leading-[66px] md:pb-12">Rocket League Specific Questions?</h2><p className="space"><span className="font-bold md:text-base">Q: How to clip in Rocket League</span><br />
