  ...
  return (
    <div>
        ...
        <div className="background bg-white px-7 pt-7 text-[11px] md:text-base md:rounded-2xl md:py-14 md:px-24 lg:w-[1200px]">
          <p className="legal text-black">Published: Oct 24, 2022<br /><br />
          ...
          <p className="legal">TO THE FULL EXTENT PERMISSIBLE BY LAW, EPIC AND ITS AFFILIATES, LICENSORS AND SERVICE PROVIDERS (“<span className="font-bold">EPIC PARTIES</span>”), WILL NOT BE LIABLE FOR ANY LOSS OF PROFITS OR ANY INDIRECT, INCIDENTAL, PUNITIVE, SPECIAL OR CONSEQUENTIAL DAMAGES ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT. FURTHER, TO THE FULL EXTENT PERMISSIBLE BY LAW, THE EPIC PARTIES’ AGGREGATE LIABILITY ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT WILL NOT EXCEED THE TOTAL AMOUNTS YOU HAVE PAID (IF ANY) TO EPIC UNDER THIS AGREEMENT DURING THE TWELVE (12) MONTHS IMMEDIATELY PRECEDING THE EVENTS GIVING RISE TO SUCH LIABILITY. THESE LIMITATIONS AND EXCLUSIONS REGARDING DAMAGES APPLY EVEN IF ANY REMEDY FAILS TO PROVIDE ADEQUATE COMPENSATION.</p>
          <p className="text-black text-base md:text-[30px] mb-6">    
          8. Indemnification
          </p>
          <p className="legal">This section only applies to the extent allowed by the laws of your jurisdiction. If the laws of your jurisdiction do not allow you to enter into the indemnification obligation below, then you assume, to the extent permitted by the laws of your jurisdiction, all liability for all claims, demands, actions, losses, liabilities, and expenses (including attorneys’ fees, costs, and expert witnesses’ fees) that are the stated subject matter of the indemnification obligation below.</p> 
          <p className="legal">
        ...
        If you have an issue that our player support can’t resolve, prior to starting arbitration you and Epic agree to attempt to resolve the dispute informally to help get us to a resolution and reduce costs for both parties. You and Epic agree to make a good-faith effort to negotiate any dispute between us for at least 30 days (“<span className="font-bold">Informal Resolution</span>”). This 30 day period starts on the day you or Epic receive a written notice of a dispute from the other party (a “<span className="font-bold">Notice of Dispute</span>”) in accordance with this Agreement.</p>
          <p className="legal">You will send your Notice of Dispute to Epic Games, Inc., Legal Department, ATTN: NOTICE OF DISPUTE, Box 254, 2474 Walnut Street, Cary, North Carolina, 27518, U.S.A. Include your name, any relevant account name you use, address, how to contact you, what the problem is, and what you want Epic to do. If Epic has a dispute with you that is subject to Informal Resolution, Epic will send our Notice of Dispute to your registered email address and any billing address you have provided us</p>
          <p className="legal">If you reside in the European Union (“EU”), you may also be entitled to submit your complaint to the European Commission’s Online Dispute Resolution (ODR) Platform. ODR allows EU consumers to resolve disputes related to the online purchases of goods and services without going to court</p>
          <p className="legal">If the dispute isn’t resolved within 30 days by Informal Resolution or small-claims court (below), you or Epic may start an arbitration in accordance with this Agreement.</p>
          <p className="legal">
        ...
        <p className="legal"> This means that you and Epic agree to a dispute-resolution process where we submit any Dispute to a neutral arbitrator (not a judge or jury) that makes the final decision to resolve the Dispute. The arbitrator may award the same remedies to you individually as a court could, but only to the extent required to satisfy your individual claim.</p>
        ...
        <p className="legal"><span className="font-bold">e.	Severability</span><br/>
        ...
        <p className="legal"><span className="font-bold">f.	Your 30-Day Right to Opt Out</span><br />
